...
const menuItems = [
  ...
  { id: 'analytics', label: 'Analytics', icon: TrendingUp, number: '08', adminOnly: true },
  { id: 'notifications', label: 'Notifications', icon: Bell, number: '09' },
  { id: 'activity', label: 'Activity Log', icon: Activity, number: '10', adminOnly: true },
  { id: 'backup', label: 'Backup/Restore', icon: HardDrive, number: '11', adminOnly: true },
];
