...
class DatabaseService {
  ...
  async init(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = (event) => {
        ...
        try {
          const storeNames = ['users', 'clients', 'receipts', 'expenses', 'activities', 'notifications', 'documents', 'employees', 'attendance', 'tasks', 'clientAccessRequests'];
  ...
  async clearAllData(): Promise<void> {
    const stores = ['users', 'clients', 'receipts', 'expenses', 'activities', 'notifications', 'documents', 'employees', 'attendance', 'tasks', 'clientAccessRequests'];
  ...
  async exportData(): Promise<string> {
    const [users, clients, receipts, expenses, activities, notifications, documents, employees, attendance, tasks, clientAccessRequests] = await Promise.all([
      this.getAllUsers(),
      this.getAllClients(),
      this.getAllReceipts(),
      this.getAllExpenses(),
